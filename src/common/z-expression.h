...
extern int32_t expression_evaluate(expression_t const * const expression, void *data);
extern int16_t expression_add_operations_string(expression_t *expression, const char *string);
