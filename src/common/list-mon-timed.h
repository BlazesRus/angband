...
MON_TMD(POIS, false, MAX, RF_IM_POIS, 10000, MON_MSG_POISONED, MON_MSG_NOT_POISONED, MON_MSG_MORE_POISONED)
MON_TMD(CUT, false, MAX, RF_NO_CUT, 10000, MON_MSG_BLEED, MON_MSG_NOT_BLEEDING, MON_MSG_MORE_BLEEDING)
