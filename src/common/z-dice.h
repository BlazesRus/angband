...
extern void dice_random_value(const dice_t *dice, void *data, random_value *v);
extern int dice_bind_expression(dice_t *dice, const char *name, const expression_t *expression);
extern int dice_evaluate(const dice_t *dice, int level, aspect asp, void *data, random_value *v);
extern int dice_roll(const dice_t *dice, void *data, random_value *v);
extern bool dice_test_values(const dice_t *dice, int base, int dice_count, int sides, int bonus);
extern bool dice_test_variables(const dice_t *dice, const char *base, const char *dice_name,
