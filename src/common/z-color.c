...
color_type color_table[MAX_COLORS] =
{
    ...
    {'I', "Light Pink", {24, 1, 12, COLOUR_L_WHITE, COLOUR_YELLOW, COLOUR_MAGENTA,
        COLOUR_YELLOW, COLOUR_YELLOW, COLOUR_L_PURPLE, COLOUR_RED}},
    {'M', "Mustard", {25, 1, 11, COLOUR_SLATE, COLOUR_YELLOW, COLOUR_SLATE,
        COLOUR_YELLOW, COLOUR_YELLOW, COLOUR_YELLOW, COLOUR_YELLOW}},
    {'z', "Blue Slate",  {26, 1, 9, COLOUR_SLATE, COLOUR_DEEP_L_BLUE, COLOUR_SLATE,
        COLOUR_DEEP_L_BLUE, COLOUR_DEEP_L_BLUE, COLOUR_L_WHITE, COLOUR_BLUE}},
    {'Z', "Deep Light Blue", {27, 1, 14, COLOUR_L_WHITE, COLOUR_L_BLUE, COLOUR_BLUE_SLATE,
        COLOUR_L_BLUE, COLOUR_L_BLUE, COLOUR_L_BLUE, COLOUR_BLUE}},
...
int color_char_to_attr(char c)
{
    ...
    /* Shimmering objects */
    if (c == 'x') return (COLOUR_MULTI);

    /* Special coloring */
    if (c == 'X') return (COLOUR_SPECIAL);
    if (c == 'S') return (COLOUR_SYMBOL);
