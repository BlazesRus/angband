MACRO(CONFIGURE_WINDOWS_FRONTEND _NAME_TARGET _ONLY_DEFINES)
    ...
    IF(NOT _ONLY_DEFINES)
        IF(NOT PREVIOUS_INVOCATION)
            ...
            SET_TARGET_PROPERTIES(OurWindowsZLib PROPERTIES IMPORTED_IMPLIB "${CMAKE_CURRENT_SOURCE_DIR}/src/SPClient/win/lib/zlib.lib")
            TARGET_INCLUDE_DIRECTORIES(OurWindowsZLib INTERFACE "${CMAKE_CURRENT_SOURCE_DIR}/src/SPClient/win/include")
            ADD_LIBRARY(OurWindowsPNGLib SHARED IMPORTED)
            SET_TARGET_PROPERTIES(OurWindowsPNGLib PROPERTIES IMPORTED_IMPLIB "${CMAKE_CURRENT_SOURCE_DIR}/src/SPClient/win/lib/libpng.lib")
            TARGET_INCLUDE_DIRECTORIES(OurWindowsPNGLib INTERFACE "${CMAKE_CURRENT_SOURCE_DIR}/src/SPClient/win/include")
        ENDIF()
