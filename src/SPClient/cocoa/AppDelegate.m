 ...
 * 4) Copy src/SPClient/cocoa/AppDelegate.h, src/SPClient/cocoa/AppDelegate.m,
 *    src/SPClient/cocoa/TileSetScaling.h, and src/SPClient/cocoa/TileSetScaling.m from the
 *    Angband source files to the directory in the project with main.m.  Copy
 *    src/SPClient/cocoa/Base.lproj/MainMenu.xib and
 *    src/SPClient/cocoa/Base.lproj/TileSetScaling.xib to the Base.lproj subdirectory
 *    of that directory.
 ...
 *    You can use them to replace the .nib files in src/SPClient/cocoa/en.lproj in the
 ...
 *    to replace src/SPClient/cocoa/en.lproj/MainMenu.nib in the Angband source files
 *    and copy Contents/Resources/Base.lproj/TileSetScaling.nib/keyedobjects.nib
 *    to replace src/SPClient/cocoa/en.lproj/TileSetScaling.nib (the
