...
struct menu
{
	...
	bool (*keys_hook)(struct menu *m, const ui_event *ev, int oid);//From Angband
	...
	bool (*context_hook)(struct menu *m, const ui_event *in, ui_event *out);//From Angband
 ...
 *   EVT_MOUSE:  unhandled mouse events(Added from Angband)
 *
 * XXX remove 'notify'
 *
...
/* Internal menu stuff */
bool menu_handle_mouse(struct menu *menu, const ui_event *in, ui_event *out);//From Angband
