...
object_base.txt
  ...
  defined in src/SPClient/list-tvals.h.  While adding new object bases is possible,
...
player_timed.txt
  ...
  have to alter src/SPClient/list-player-timed.h and probably other files, and
  re-compile the game.
...
projection.txt
  ...
  projections have to be included in src/SPClient/list-projections.h, and the code to
  implement their effects put in other source files - src/SPClient/project-obj.c for
...
summon.txt
  ...
  hard-coded in src/SPClient/list-mon-spells.h.
