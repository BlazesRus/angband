 ...
 * 4) Copy SinglePlayerSrc/cocoa/AppDelegate.h, SinglePlayerSrc/cocoa/AppDelegate.m,
 *    SinglePlayerSrc/cocoa/TileSetScaling.h, and SinglePlayerSrc/cocoa/TileSetScaling.m from the
 *    Angband source files to the directory in the project with main.m.  Copy
 *    SinglePlayerSrc/cocoa/Base.lproj/MainMenu.xib and
 *    SinglePlayerSrc/cocoa/Base.lproj/TileSetScaling.xib to the Base.lproj subdirectory
 *    of that directory.
 ...
 *    You can use them to replace the .nib files in SinglePlayerSrc/cocoa/en.lproj in the
 ...
 *    to replace SinglePlayerSrc/cocoa/en.lproj/MainMenu.nib in the Angband source files
 *    and copy Contents/Resources/Base.lproj/TileSetScaling.nib/keyedobjects.nib
 *    to replace SinglePlayerSrc/cocoa/en.lproj/TileSetScaling.nib (the
